...
class Instructions {
    ...
    public static function transferSPL(
        ...
        $data = pack('C', InstructionTypes::Transfer->value) . $amount; // No need for decimals in the data for a transfer instruction
    ...
    public static function burnSPL(
        ...
        $data = pack('C', InstructionTypes::Burn->value) . $amount;
